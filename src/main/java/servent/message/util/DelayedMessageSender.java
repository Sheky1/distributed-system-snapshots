    ...
    public void run() {
        ...
        try {
            ...
            synchronized (AppConfig.colorLock) {
                messageToSend = messageToSend.setInitiatorVersions();
            ...
            AppConfig.timestampedErrorPrint("Error stack trace: " + Arrays.toString(e.getStackTrace()));
            AppConfig.timestampedErrorPrint("Error message: " + e.getMessage());
        }
    }
