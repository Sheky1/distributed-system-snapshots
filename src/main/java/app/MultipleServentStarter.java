...
public class MultipleServentStarter {
	...
	private static void startServentTest(String testName) {
		...
		for(int i = 0; i < serventCount; i++) {
			try {
//				ProcessBuilder builder = new ProcessBuilder("java", "-cp", "out/production/KiDS8-LaiYang", "app.ServentMain",
//						testName+"/servent_list.properties", String.valueOf(i));
//				ProcessBuilder builder = new ProcessBuilder("java", "-cp", "target/classes/main/java", "app.ServentMain",
//						testName+"/servent_list.properties", String.valueOf(i));
	...
	public static void main(String[] args) {
		startServentTest("mix");
//		startServentTest("distributed");
//		startServentTest("multipleCollect");
	}
