...
public class AppConfig {
	...
	public static Map<Integer, Integer> initiatorVersions = new HashMap<>();
	public static Set<Integer> regions = new HashSet<>();
	public static int collectedChildren = 0;
	public static int treeResetConfirmed = 0;
	public static Map<Integer, Map<Integer, Boolean>> blanks = new ConcurrentHashMap<>();
	...
	public static void readConfig(String configName){
		...
		for(String initString: initiators) initiatorVersions.put(Integer.parseInt(initString), 0);
		blanks.put(0, new HashMap<>());
